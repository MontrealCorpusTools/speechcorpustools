...
with CorpusContext('buckeye', **graph_db) as g:
    ...
    q = q.clear_columns().times().columns(g.word.label.column_name('orthography'),
                ...
                g.word.utterance.surface_transcription.rate.column_name('utterance_surface_phones_per_second'),
                g.word.utterance.surface_transcription.count.column_name('utterance_surface_phones_number'),
